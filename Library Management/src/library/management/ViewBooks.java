...
public class ViewBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BOOK_ID", "CATEGORY", "NAME", "AUTHOUR", "NO_COPIES"
            }
        ));
    ...
    private void fetchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fetchActionPerformed
        ...
        while(res.next()){
            ...
            String authour=res.getString("AUTHOUR");
            int copies=res.getInt("NO_COPIES");
            model.addRow(new Object[]{id,category,name,authour,copies});
